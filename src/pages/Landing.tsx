...
export const Landing = () => {
  return (
    <div className="min-h-screen bg-linear-to-br from-violet-600 to-indigo-800 flex items-center justify-center p-6">
      {/* Hero Section */}
      <div className="max-w-4xl text-center text-white">
        ...
        <p className="text-xl md:text-2xl mb-12 text-violet-100">
          Track expenses, set budgets, and reach your financial goals — all in
          one place.
        </p>
