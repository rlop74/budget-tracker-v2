    ...
    <div className="space-y-8 p-6 overflow-y-auto max-h-60">
      {[...allGoals]
        ...
        .map((goal) => {
          ...
          return (
            <div key={goal.id} className="space-y-2 capitalize">
              ...
              <div className="flex gap-1 w-full bg-gray-400 rounded-full h-5 overflow-hidden relative">
                <div
                  className="h-full bg-linear-to-r from-violet-500 to-indigo-600 rounded-full transition-all duration-700 ease-out"
